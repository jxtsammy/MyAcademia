  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subText}>
        A code has been sent to your <Text style={styles.Email}> Email</Text>
      </Text>
      ...
      <TouchableOpacity style={styles.verifyButton} onPress={() => navigation.navigate('Home')}>
        <Text style={styles.verifyButtonText}>Verify Now</Text>
      </TouchableOpacity>

      <Image
          source={require('../../assets/VerificationCode.png')} // Replace with your image path
          style={styles.image}
        />
    </View>
  );
